...
- Files can be dragged into the order you want them converted in, both in the ready list and among the jobs still waiting in Converting. A grip handle marks the rows that can move; running files and finished files stay put, and an archive moves as one block.
