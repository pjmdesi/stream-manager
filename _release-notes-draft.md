...
- Preview mode: an Edit/Preview toggle above the layers panel swaps the canvas for mockups of real YouTube surfaces (home card, search result, suggested rail, compact row) with duration/LIVE badges, watched-progress bar, and a light-theme toggle. The properties panel stays live — tweak a font size and watch every mockup size update. Uses your Streamer Name setting for the channel line.
