...
- Rotation snapping: hold Ctrl while dragging the rotate handle to snap to 90 degree steps, or Shift for 5 degree steps, and the current angle shows beside the pointer while you rotate. Rotating also no longer stretches the layer when the smart-snap guides light up.
