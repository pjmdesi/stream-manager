...
- Color palette panel in the editor sidebar (phase 1: default swatch set — black→white run, spectrum colors, brown; applying and managing colors lands in the next phases; reword this line when they do).
