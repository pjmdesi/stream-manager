...
- Stream rows show the linked YouTube video's views, likes, and dislikes in a new column beside the date. Hover for the exact figures. They arrive with the status check that already runs, so they cost no extra quota.
