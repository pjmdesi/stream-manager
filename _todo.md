...
7. The "Open" item in the taskbar icon menu should be above the exit item, all the non-interactive info for the watcher and converter should be above that.
...
10. Upgrades to the thumbnail creator:
