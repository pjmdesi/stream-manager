...
1. Need to think about updating the about modal because the app has way more features now.
2. Add a "Send to converter" button to the streams page for the multi-select mode.
...
8. More merge fields for use in the stream item details:
