...
3. The destination link for active conversion tasks is truncating unnecessarily.![alt text](image-1.png)
...
5. More merge fields for the stream item details. A snippets manager (basically user-created merge fields).
